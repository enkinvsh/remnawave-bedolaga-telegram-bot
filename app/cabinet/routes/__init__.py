...
from .admin_bot_menu import router as admin_bot_menu_router
...
from .admin_email_lifecycle import router as admin_email_lifecycle_router
...
# Конструктор меню БОТА (menu_layout_config) — отдельная система от menu-layout выше
router.include_router(admin_bot_menu_router)
