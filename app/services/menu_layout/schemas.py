...
class ButtonConditions(BaseModel):
    ...
    contests_visible: bool | None = Field(default=None, description='Конкурсы включены и кнопка разрешена')
    activate_button_visible: bool | None = Field(default=None, description='Кнопка активации разрешена настройкой')
