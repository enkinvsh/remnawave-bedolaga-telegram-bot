...
DEFAULTS: dict[str, RuleDescriptor] = {
    ...
    'trial_not_activated': RuleDescriptor(
        ...
        config={
            ...
            'max_repeats': 3,
            'message_template': (
                'У тебя есть бесплатный пробный доступ. Активируй сейчас — это 1 клик, без оплаты.'
            ),
            'repeat_message_template': (
                '🎁 Ты ещё не активировал бесплатный пробный VPN! '
                'Попробуй — 1 клик, без оплаты и привязки карты.'
            ),
    ...
    'trial_zero_traffic': RuleDescriptor(
        ...
        config={
            ...
            'message_templates': {
                '1': (
                    'Пробный VPN активирован, но трафика пока ноль. '
                    'Давай подключимся — это пара минут.'
                ),
                '24': (
                    'Пробный доступ уже идёт, а ты ещё не подключился. '
                    'Настрой VPN, чтобы не терять бесплатные дни.'
                ),
            },
    ...
    'trial_ending': RuleDescriptor(
        ...
        config={
            'hours_before': 2,
            'message_template': (
                'Через {hours} ч. заканчивается пробный доступ. '
                'Оформи подписку, чтобы не остаться без VPN.'
            ),
        },
        placeholders=('{hours}',),
    ),
    ...
    'post_trial_ladder': RuleDescriptor(
        ...
        config={
            ...
            'message_template': (
                'Пробный период закончился. Держи скидку {percent}% — '
                'успей оформить подписку за {hours} ч.'
            ),
